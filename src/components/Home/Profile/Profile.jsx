   ...
   <section className="size flex gap-[4rem] relative">
    ...
    <div className ="mt-[9rem] flex-[2]">
        <div className ="flex items-end gap-4">
            <h2 className="text-4xl sm:text-4xl font-semibold capitalize font-poppins">
    ...
    ${modal ? "translate-x-0" : "translate-x-[100%] md:translate-x-0"}
     transition-all-durantion-500 `}>
        ...
        <div className="sticky top-7 flex flex-col justify-between">
            <img className="w-[3.5rem] h-[3.5rem] object-cover rounded-full"
                 src={getUserData?.userImg || "/profile.jpg"}
                 alt="profile image" 
            />
            <h2 className="py-2 font-bold capitalize font-Helvetica Neue">Michael Ndudi</h2>
            <p className = "text-gray-500 first-letter:uppercase text-sm" >I am a student and software engineer</p>
            <button 
